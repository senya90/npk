...
export const fertilizersMock: Fertilizer[] = [
    ...
    new Fertilizer(
        'Удобрение 3',
        [
            new FertilizerIngredient('5Mg', 1.2, '2b346d3a-9144-44b5-876d-f57d71835b83'),
            new FertilizerIngredient('4Ca', 0.5, '1991ccdd-a335-4bc8-9b71-1c3c286ea132'),
    ...
    new Fertilizer(
        'Удобрение 4',
        [
            new FertilizerIngredient('8Fe', 10, '1fb853e0-3914-47db-ad5b-a7037e79ef84'),
        ],
    ...
    new Fertilizer(
        'Удобрение 5',
        [
            new FertilizerIngredient('10MgSO47H2O', 23.55, '3b2fe6ad-d548-4493-99ad-07f735b40264'),
            new FertilizerIngredient('8Fe', 1, '1fb853e0-3914-47db-ad5b-a7037e79ef84'),
        ],
    ...
    new Fertilizer(
        ...
        [
            new FertilizerIngredient('9MgSO4', 11.22, 'ede68881-6581-45fd-9ef9-bcbb32ac3784')
        ],
