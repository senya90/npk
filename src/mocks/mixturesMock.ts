 ...
 *              Mg доля от процента = 0.1122 * 0.20192478 = 0.02265596
 ...
 *          S доля = 32.064 / 246.47398 = 0.13009
 *          O4 доля = 15.9994 * 4 / 246.47398 = 0.25965
 *          +
 *          H доля = 7 * 2 * 1.00797 / 246.47398 = 0.05725
 *          O доля = 7 * 15.9994 / 246.47398 = 0.4544
 * 
 *              Mg доля от процента = 0.046 * 0.098611 = 0.004536
 *              S доля от процента = 0.046 * 0.13009 = 0.00598
 *              O доля от процента = 0.046 * 0.25965 = 0.01194
 *              +
 *              H доля от процента = 0.046 * 0.05725 = 0.0026
 *              O доля от процента = 0.046 * 0.4544 = 0.0209
 * 
 *                  Mg масса = 1000 * 5 * 0.004536 = 22.68
 *                  S масса = 1000 * 5 * 0.00598 = 29.9
 *                  O масса = 1000 * 5 * 0.01194 = 59.7
 *                  +
 *                  H масса = 1000 * 5 * 0.0026 = 13
 *                  O масса = 1000 * 5 * 0.0209 = 104.5
 * 
 *                      ОБЩЕЕ:
 *                          Mg масса = 22.68
 *                          S масса = 29.9
 *                          O масса = 59.7 + 104.5 = 164.2
 *                          H масса = 13
 * 
 *          ОБЩЕЕ:
 *              Mg = 550 + 32.308 + 22.68 = 604.99 mg
