...
import { CustomIcon } from 'components/atom/customIcon/CustomIcon';
...
export function IconsProvider(iconType: ICON_TYPE, size = 30, color = '#000000') {
    switch (iconType) {
        ...
        case (ICON_TYPE.BucketWithLiquid):
            return <CustomIcon iconType={ICON_TYPE.BucketWithLiquid} size={size} color={color}/>
